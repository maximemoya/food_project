...
public class ResultFoodSelectorV2ActivityNutriScoreGlobalElements extends AppCompatActivity {

    private Context context;
    private TextView nutriScoreTextView, dayTimeTextView, besoinJournalierTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TransitionClass.activityToBackUpByCancel = LibraryArrayBitmapDrawingRessources.enumActivityBackUpByCancel.RESULTFOODSELECTORV2NUTRISCOREGLOBALELEMENTS.ordinal();
        TransitionClass.activityToBackUpByCancelLevel2 = LibraryArrayBitmapDrawingRessources.enumActivityBackUpByCancel.RESULTFOODSELECTORV2NUTRISCOREGLOBALELEMENTS.ordinal();
        ...
        besoinJournalierTextView = findViewById(R.id.resultNutriScorefoodSelectorV2_BesoinJournalierTextView);
    ...
    private void affichageVerticalValuesInScrollView() {
        ...
        for (int i = 0; i < profileUser.getDailyNeedDOUBLEValuesList().size(); i++) {
            ...
            textView1.setTextColor(this.getColor(arrayListColorText.get(i)));
            ...
            String[] textArray = FoodClass.getArrayStringTotalFoodAllElements(arrayTotalFoodValues);
            textView2.setText(textArray[i]);

            textView2.setTextColor(this.getColor(arrayListColorText.get(i)));
            ...
            // set text DailyNeed User Values (ex: 2000 kCal) :
            ...
            if(besoinJournalierPercent){
                text = TransitionClass.profileActual.getDailyNeedPercentSTRINGlist(arrayTotalFoodValues).get(i);
            }
            else {
                text = TransitionClass.profileActual.getDailyNeedSTRINGlist(context).get(i);
            }
            textView3.setText(text);

            textView3.setTextColor(this.getColor(arrayListColorText.get(i)));
    ...
    private ArrayList<Integer> getImageFoodByComparing(ArrayList<FoodClass> arrayListFood) {
        ...
        ArrayList<Integer> intImgResultList = new ArrayList<>();

        Collections.sort(arrayListFood, FoodClass.comparatorCaloriesMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        ...
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorFibreMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        ...
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineAMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineB1MultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineB2MultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineB3MultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineB5MultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineB6MultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineB9MultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineB12MultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineCMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineDMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorVitamineEMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorEauMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorCalciumMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorCuivreMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorFerMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorIodeMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorMagnesiumMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorManganeseMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorPhosphoreMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorPotassiumMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorSeleniumMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorSodiumMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);
        Collections.sort(arrayListFood, FoodClass.comparatorZincMultiplyByQuantity);
        intImgResultList.add(foodList.get(0).bitmapRawRessource);

        return intImgResultList;
    }
